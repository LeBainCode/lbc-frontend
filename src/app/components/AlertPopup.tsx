        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div className="bg-[#1F2937] rounded-lg max-w-md w-full p-6 shadow-xl">
                <div className="flex justify-between items-start mb-4">
                    <h2 className="text-2xl font-bold text-white">Beta Testing Opportunity! 🚀</h2>
                    <button 
                        onClick={handleClose}
                ...
                <div className="text-gray-300 space-y-4">
                    <p>
                        Welcome to LeBainCode! Our platform is currently in development, 
                        and while some features are not yet fully accessible, we're 
                        looking for beta testers to help shape the future of our platform.
                    </p>
                    ...
                    <div className="bg-[#374151] p-4 rounded-lg">
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-center">
                                <span className={`mr-2 ${hasEmail ? 'text-green-400' : 'text-yellow-400'}`}>
                                    {hasEmail ? '✓' : '•'}
                                </span>
                                {hasEmail ? (
                                    'Email verified ✨'
