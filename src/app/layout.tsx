...
export const metadata: Metadata = {
  ...
  description: 'Immersive coding education platform where you learn by doing. Join our community of developers and start your coding journey today.',
  keywords: ['coding bootcamp', 'learn to code', 'programming education', 'web development', 'software engineering'],
  openGraph: {
    title: 'Le Bain Code | Learn to Code by Jumping in the Deep End',
